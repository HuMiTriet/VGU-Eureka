...
class _SOSChatScreenState extends State<SOSChatRoomView> {
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder(
        future: FirestoreSOSChat.getChatroomUID(user.uid, widget.selectedUser.uid),
        builder: (context, futureSnapshot) {
          if (futureSnapshot.connectionState == ConnectionState.done) {
            chatroomUID = futureSnapshot.data as String;
            messageStream = FirestoreSOSChat.getMessageStream(chatroomUID);
